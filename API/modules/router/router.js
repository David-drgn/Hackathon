...
router.use(
  "/pages/routerlink",
  express.static(
    path.join(__dirname, "..", "..", "view", "pages", "routerlink")
  )
);
...
router.use(
  "/pages/PopUp/redes",
  express.static(
    path.join(__dirname, "..", "..", "view", "pages", "PopUp", "redes")
  )
);
...
router.use(
  "/pages/PopUp/event",
  express.static(
    path.join(__dirname, "..", "..", "view", "pages", "PopUp", "event")
  )
);
...
router.use(
  "/pages/PopUp/service",
  express.static(
    path.join(__dirname, "..", "..", "view", "pages", "PopUp", "service")
  )
);
